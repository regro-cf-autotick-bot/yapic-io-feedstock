...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yapic-io-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15184&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yapic-io-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yapic-io` can be installed with:

```
conda install yapic-io
```

It is possible to list all of the versions of `yapic-io` available on your platform with:
